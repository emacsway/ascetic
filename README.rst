...
* `Storm <https://storm.canonical.com/>`_ (properties from class) - excellent and simple ORM! Article (in Russian) `Why did I choose the Storm ORM? <http://emacsway.bitbucket.org/ru/storm-orm/>`_
