...
* Article (in English) "`Why I prefer Storm ORM for Python <https://emacsway.bitbucket.io/en/storm-orm/>`_"
* Article (in Russian) "`Почему я выбираю Storm ORM для Python <https://emacsway.bitbucket.io/ru/storm-orm/>`_"
